...
export default function Navbar({ searcher, porfin }) {
    ...
    <div>
      <nav className="navbar navbar-expand-lg  bg-body-tertiary ">
        <div className="container-fluid">
          ...
          <a href='/' className="navbar-brand">Tú pedido</a>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav navbar-nav me-auto mb-2 mb-lg-0">
                <form className="d-flex" role="search">
                  ...
                  <button onClick= {()=>{tosearch()}} className="btn btn-outline-info" type="submit">Buscar</button>
                </form>
