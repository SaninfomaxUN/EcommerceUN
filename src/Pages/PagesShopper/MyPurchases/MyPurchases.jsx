                                    ...
                                    <table className='product-table'>
                                        ...
                                        {pedido["ListadoProductos"].map((producto) => (
                                            <tr key={producto["ID_LISTPEDIDO"]} className="product-show">
                                                ...
                                                <td><img className='image' src={producto["Producto"]["IMAGEN"]}
                                                         alt="Producto"
                                                         onClick={() => handleClick(producto["Producto"]["N_PRODUCTO"], producto["Producto"]["ID_PRODUCTO"])}/>
                                                </td>
                                                <td className='product-name-1'
                                                    onClick={() => handleClick(producto["Producto"]["N_PRODUCTO"], producto["Producto"]["ID_PRODUCTO"])}>{producto["Producto"]["N_PRODUCTO"].substring(0, 30)}</td>
